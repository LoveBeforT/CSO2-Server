...
func OnRegister() {
	...
	http.HandleFunc("fonts/boxicons.woff2", OnJpg)
	...
	http.HandleFunc("fonts/Flaticon.woff2", OnJpg)
	http.HandleFunc("fonts/Flaticond41d.eot", OnJpg)
	http.HandleFunc("fonts/Vermin-Vibes-V.ttf.eot", OnJpg)
	http.HandleFunc("fonts/Vermin-Vibes-V.ttf.svg", OnJpg)
	http.HandleFunc("fonts/Vermin-Vibes-V.ttf.woff", OnJpg)
